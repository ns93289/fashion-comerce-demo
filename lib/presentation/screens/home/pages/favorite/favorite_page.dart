                  ...
                  itemBuilder: (context, index) {
                    ...
                    return GestureDetector(
                      ...
                      child: ItemProduct(
                        ...
                        onFavorite: () {
                          ref.read(favoriteListServiceProvider.notifier).callRemoveFavoriteApi(product.productId).then((value) {
                            if (value) {
                              ref.read(favoriteListServiceProvider.notifier).callFavoriteProductsApi();
                            }
                          });
                        },
                      ),
